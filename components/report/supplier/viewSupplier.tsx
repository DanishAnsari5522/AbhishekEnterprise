...
export default function SupplierViewTable() {
        ...
        <>
            ...
            >
                <TableHeader>
                    ...
                    <TableColumn key="pay">pay Status</TableColumn>
                ...
                <TableBody items={items}>
                    {(item) => (
                        <TableRow key={1}>
                            ...
                            <TableCell>{
                            getKeyValue(item, 'payment')==true?<p className="text-green-800">Done</p>:<p className="text-red-800">Not</p>
                            }</TableCell>
