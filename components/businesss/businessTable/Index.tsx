...
const INITIAL_VISIBLE_COLUMNS = ["name", "gstno", "location", "status", "actions"];
const users = [
  {
    id: 1,
    name: "Tony Reichert",
...
export default function BusinessTable() {
  ...
  useEffect(() => {
    getBusiness();
    if (dataAllInd && dataAllGog) {
      console.log('done', dataAllInd.length);

      console.log(dataAllInd);
      data.push(...[...dataAllInd, ...dataAllGog])
      console.log(data);
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button color="primary" startContent={<PlusIcon />} className="bg-yellow-500">
              Add Proposal
            </Button>
          </div>
        </div>
